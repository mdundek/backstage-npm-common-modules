export { 
  BackstageComponentRegistrar,
  GitlabInputsParameters,
  GlobalInputsParameters,
  ComponentInputsParameters
} from './libs/backstageRegistrar';
...
export { DNSController } from './libs/dnsController';
